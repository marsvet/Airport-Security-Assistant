...
-- MySQL dump 10.13  Distrib 5.7.27, for Linux (x86_64)
--
-- Host: localhost    Database: avaition
-- ------------------------------------------------------
-- Server version	5.7.27-0ubuntu0.18.04.1
...
LOCK TABLES `具体物品` WRITE;
/*!40000 ALTER TABLE `具体物品` DISABLE KEYS */;
INSERT INTO `具体物品` VALUES (1,'手枪','以及物品的仿真品',4,'/',1,1),(2,'烟花爆竹','以及物品的仿真品',4,'/',3,2),(3,'步枪','以及物品的仿真品',4,'/',1,1),(4,'烟饼','以及物品的仿真品',4,'/',3,2),(5,'冲锋枪','以及物品的仿真品',4,'/',1,1),(6,'黄烟','以及物品的仿真品',4,'/',7,2),(7,'机枪','以及物品的仿真品',4,'/',1,1),(8,'礼花弹','以及物品的仿真品',4,'/',7,2),(9,'匕首','以及物品的仿真品',4,'/',9,3),(10,'防暴枪','以及物品的仿真品',4,'/',1,1),(11,'三棱刮刀','',4,'/',9,3),(12,'气枪','以及物品的仿真品',4,'/',2,1),(13,'猎枪','以及物品的仿真品',4,'/',2,1),(14,'跳刀','带有自锁装置',4,'/',9,3),(15,'射击运动枪','以及物品的仿真品',4,'/',2,1),(16,'弹簧刀','带有自锁装置',4,'/',9,3),(17,'刀具','刀尖角度大于60度刀身长度超过220毫米的各类单刃、双刃、多刃刀具',4,'/',9,3),(18,'麻醉注射枪','以及物品的仿真品',4,'/',2,1),(19,'弩',NULL,4,'/',11,3),(20,'道具枪','以及物品的仿真品',4,'/',3,1),(21,'发令枪','以及物品的仿真品',4,'/',3,1),(22,'氢气',NULL,4,'/',12,4),(23,'甲烷',NULL,4,'/',12,4),(24,'钢珠枪','以及物品的仿真品',4,'/',3,1),(25,'乙烷',NULL,4,'/',12,4),(26,'境外枪支以及各类非法制造的枪支','以及物品的仿真品',4,'/',3,1),(27,'丁烷',NULL,4,'/',12,4),(28,'炸弹','以及物品的仿真品',4,'/',5,2),(29,'天然气',NULL,4,'/',12,4),(30,'手榴弹','以及物品的仿真品',4,'/',5,2),(31,'乙烯',NULL,4,'/',12,4),(32,'照明弹','以及物品的仿真品',4,'/',5,2),(33,'丙烯',NULL,4,'/',12,4),(34,'燃烧弹','以及物品的仿真品',4,'/',5,2),(35,'乙炔','溶于介质的',4,'/',12,4),(36,'烟幕弹','以及物品的仿真品',4,'/',5,2),(37,'一氧化碳','',4,'/',12,4),(38,'信号弹','以及物品的仿真品',4,'/',5,2),(39,'催泪弹','以及物品的仿真品',4,'/',5,2),(40,'液化石油气',NULL,4,'/',12,4),(41,'毒气弹','以及物品的仿真品',4,'/',5,2),(42,'氟利昂',NULL,4,'/',12,4),(43,'子弹','以及物品的仿真品',4,'/',5,2),(44,'氧气',NULL,4,'/',12,4),(45,'二氧化碳',NULL,4,'/',12,4),(46,'铅弹','以及物品的仿真品',4,'/',5,2),(47,'水煤气',NULL,4,'/',12,4),(48,'空包弹','以及物品的仿真品',4,'/',5,2),(49,'打火机燃料',NULL,4,'/',12,4),(50,'教练弹','以及物品的仿真品',4,'/',5,2),(51,'黄磷',NULL,4,'/',13,4),(52,'白磷',NULL,4,'/',13,4),(53,'硝化纤维','含胶片',4,'/',13,4),(54,'油纸','及其制品',4,'/',13,4),(55,'红磷',NULL,4,'/',15,4),(56,'闪光粉',NULL,4,'/',15,4),(57,'固体酒精',NULL,4,'/',15,4),(58,'赛瑞珞',NULL,4,'/',15,4),(59,'发泡剂',NULL,4,'/',15,4),(60,'汽油',NULL,4,'/',16,4),(61,'煤油',NULL,4,'/',16,4),(62,'柴油',NULL,4,'/',16,4),(63,'苯',NULL,4,'/',16,4),(64,'乙醇','酒精',4,'/',16,4),(65,'丙酮',NULL,4,'/',16,4),(66,'乙醚',NULL,4,'/',16,4),(67,'油漆',NULL,4,'/',16,4),(68,'稀料',NULL,4,'/',16,4),(69,'松香油','及含易燃溶剂制品',4,'/',16,4),(70,'氯化物',NULL,4,'/',18,4),(71,'碰霜',NULL,4,'/',18,4),(72,'农药','剧毒的，以及剧毒化学品',4,'/',18,4),(73,'乙肝病毒','炭疽杆菌',4,'/',19,5),(74,'结核杆菌',NULL,4,'/',19,5),(75,'艾滋病病毒',NULL,4,'/',19,5),(76,'打火机',NULL,4,'/',19,5),(77,'火柴',NULL,4,'/',19,5),(78,'点烟器',NULL,4,'/',19,5),(79,'打火石','镁棒',4,'/',19,5),(80,'镁棒','打火石',4,'/',19,5),(81,'充电宝','',5,'随身携带时：1.标识全面清晰，额定能量小于或等于100Wh；2.当额定能量大于100Wh、小于或等于160Wh时必须经航空公司批准且每人限带两块。必须托运时:额定能量超过160Wh。',38,11),(82,'锂电池','电动轮椅使用的锂电池另有规定',5,'随身携带时：对于可卸下的轮椅用锂电池，额定能量应不超过300Wh。经承运人批准后，方可将锂电池卸下携带登机；旅客可携带1块不超过300Wh的备用电池，或2块不超过160Wh的备用电池。必须托运时: 对于电动轮椅或代步工具的锂电池：其电池不可拆卸的，应进行托运。',38,11),(83,'强磁化物',NULL,2,'无',39,5),(84,'刺激性气体',NULL,2,'无',39,5),(85,'菜刀','刀刃长度大于6厘米',2,'无',27,7),(86,'水果刀',NULL,2,'无',27,7),(87,'剪刀',NULL,2,'无',27,7),(88,'美工刀',NULL,2,'无',27,7),(89,'裁纸刀',NULL,2,'无',27,7),(90,'手术刀',NULL,2,'无',28,7),(91,'屠宰刀',NULL,2,'无',28,7),(92,'雕刻刀',NULL,2,'无',28,7),(93,'创刀',NULL,2,'无',28,7),(94,'铣刀',NULL,2,'无',28,7),(95,'文艺表演刀','用作武术文艺表演的刀',2,'无',29,7),(96,'矛',NULL,2,'无',29,7),(97,'剑',NULL,2,'无',29,7),(98,'戴',NULL,2,'无',29,7),(99,'棍棒','含伸缩棍、双节棍',2,'无',30,8),(100,'伸缩棍',NULL,2,'无',30,8),(101,'双节棍',NULL,2,'无',30,8),(102,'球棒',NULL,2,'无',30,8),(103,'桌球杆',NULL,2,'无',30,8),(104,'板球球拍',NULL,2,'无',30,8),(105,'曲棍球杆',NULL,2,'无',30,8),(106,'高尔夫球杆',NULL,2,'无',330,8),(107,'登山杖',NULL,2,'无',30,8),(108,'滑雪杖',NULL,2,'无',30,8),(109,'指节铜套','手钉',2,'无',30,8),(110,'手钉','指节铜套',2,'无',30,8),(111,'钻机','含钻头',2,'无',31,9),(112,'凿',NULL,2,'无',31,9),(113,'锥',NULL,2,'无',31,9),(114,'锯',NULL,2,'无',31,9),(115,'螺栓枪',NULL,2,'无',31,9),(116,'射钉枪',NULL,2,'无',31,9),(117,'螺丝刀',NULL,2,'无',31,9),(118,'撬棍',NULL,2,'无',31,9),(119,'锤',NULL,2,'无',31,9),(120,'钳',NULL,2,'无',31,9),(121,'焊枪',NULL,2,'无',31,9),(122,'扳手',NULL,2,'无',31,9),(123,'斧头',NULL,2,'无',31,9),(124,'短柄小斧','太平斧',2,'无',31,9),(125,'游标卡尺',NULL,2,'无',31,9),(126,'冰镐',NULL,2,'无',31,9),(127,'碎冰锥',NULL,2,'无',31,9),(128,'飞镖',NULL,2,'无',32,9),(129,'弹弓',NULL,2,'无',32,9),(130,'弓',NULL,2,'无',32,9),(131,'箭',NULL,2,'无',32,9),(132,'蜂鸣自卫器',NULL,2,'无',32,9),(133,'电击器','不在国家规定管制范圈内的',2,'无',32,9),(134,'梅斯气体',NULL,2,'无',32,9),(135,'泪瓦斯',NULL,2,'无',32,9),(136,'胡椒辣椒喷剂',NULL,2,'无',32,9),(137,'酸性喷雾剂',NULL,2,'无',32,9),(138,'驱除动物喷剂',NULL,2,'无',32,9),(139,'含有酒精的液体',NULL,2,'作为行李托运时：1.标识全面清晰且置于零售包装内，每个容器容积不得超过5L；2.酒精的体积百分含量小于或等于24%时，托运数量不受限制；3.酒精的体积百分含量大于24%、小于或等于70%时，每位旅客托运数量不超过5L。',33,10),(140,'液态乳制品','婴儿航空旅行途中必需的',3,'经安全检查确认后可随身携带。作为行李托运无限定条件。',34,10),(141,'液态药品','糖尿病或者其他疾病患者航空旅行途中必蓄的',3,'经安全检查确认后可随身携带。作为行李托运无限定条件。',34,10),(142,'茶水','茶水、饮料等所有液态物品',3,'一、乘坐国际、地区航班时：随身携带时：液态物品应当盛放在单体容器容积不超过100mL的容器内随身携带；2.盛放液态物品的容器应置于最大容积不超过1L、可重新封口的透明塑料袋中；每名旅客每次仅允许携带一个透明塑料袋，超出部分应作为行李托运。作为行李托运无限定条件。二、乘坐国内航班：随身携带时：仅航空旅行途中自用的化妆品（每种限带一件、盛放在单体容器容积不超过100mL的容器内、接受开瓶检查）、牙膏（每种限带一件且不得超过100g（mL））及剃须膏（每种限带一件且不得超过100g（mL））可随身携带。作为行李托运无限定条件。三、在同一机场控制区内由国际、地区航班转乘国内航班：随身携带入境的免税液态物品（出示购物凭证、置于已封口且完好无损的透明塑料袋中、经安全检查确认）可随身携带。作为行李托运无限定条件。',39,10),(143,'饮料','茶水、饮料等所有液态物品',3,'一、乘坐国际、地区航班时：随身携带时：液态物品应当盛放在单体容器容积不超过100mL的容器内随身携带；2.盛放液态物品的容器应置于最大容积不超过1L、可重新封口的透明塑料袋中；每名旅客每次仅允许携带一个透明塑料袋，超出部分应作为行李托运。作为行李托运无限定条件。二、乘坐国内航班：随身携带时：仅航空旅行途中自用的化妆品（每种限带一件、盛放在单体容器容积不超过100mL的容器内、接受开瓶检查）、牙膏（每种限带一件且不得超过100g（mL））及剃须膏（每种限带一件且不得超过100g（mL））可随身携带。作为行李托运无限定条件。三、在同一机场控制区内由国际、地区航班转乘国内航班：随身携带入境的免税液态物品（出示购物凭证、置于已封口且完好无损的透明塑料袋中、经安全检查确认）可随身携带。作为行李托运无限定条件。',39,10),(169,'钾',NULL,4,'/',14,4),(170,'钠',NULL,4,'/',14,4),(171,'锂',NULL,4,'/',14,4),(172,'碳化钙','电石',4,'/',14,4),(173,'电石','碳化钙',4,'/',14,4),(174,'镁铝粉',NULL,4,'/',14,4),(175,'炸药',NULL,4,'/',6,2),(176,'雷管',NULL,4,'/',6,2),(177,'引信',NULL,4,'/',6,2),(178,'起爆管',NULL,4,'/',6,2),(179,'导火索',NULL,4,'/',6,2),(180,'导爆索',NULL,4,'/',6,2),(181,'爆破剂',NULL,4,'/',6,2),(182,'警棍',NULL,4,'/',10,3),(183,'警用电击器',NULL,4,'/',10,3),(184,'军用或警用的匕首',NULL,4,'/',10,3),(185,'手铐',NULL,4,'/',10,3),(186,'拇指铐',NULL,4,'/',10,3),(187,'脚僚',NULL,4,'/',10,3),(188,'催泪喷射器',NULL,4,'/',10,3),(189,'高锰酸钾',NULL,4,'/',17,4),(190,'氯酸钾',NULL,4,'/',17,4),(191,'过氧化钠',NULL,4,'/',17,4),(192,'过氧化钾',NULL,4,'/',17,4),(193,'过氧化铅',NULL,4,'/',17,4),(194,'过醋酸',NULL,4,'/',17,4),(195,'双氧水',NULL,4,'/',17,4);
/*!40000 ALTER TABLE `具体物品` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-10 16:27:33
-- MySQL dump 10.13  Distrib 5.7.27, for Linux (x86_64)
--
-- Host: localhost    Database: aviation
-- ------------------------------------------------------
...
-- Dump completed on 2019-09-17 23:47:28
