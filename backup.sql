...
CREATE TABLE `具体物品` (
  ...
  `限定规格` varchar(500) CHARACTER SET utf8 DEFAULT NULL COMMENT '为“null”时：该物品不能携带；\r\n为”无“时：该物品没有限定规格；',
  `统称_id` int(10) NOT NULL,
  `所属分类_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`物品_id`,`物品_name`) USING BTREE,
  UNIQUE KEY `Uni_物品name` (`物品_name`) USING BTREE,
...
-- Dump completed on 2019-10-15 20:18:30
